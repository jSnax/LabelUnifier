...
public class PhraseList {
	...
	public void phraseCompareAndDecision(LabelList labelList) {
		System.out.println("Die vollstï¿½ndige Phrasenlist beinhaltet:");
		...
		for (int zaehlerLabels = 0; zaehlerLabels < this.wholeInput.size(); zaehlerLabels++) {
				...
				//here we go further in the each phrase and check each entry. We start at next entry of zÃ¤hlerlabels and traverse 
